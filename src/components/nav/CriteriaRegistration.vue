<template>
  <v-row justify="left">
    <v-dialog v-model="dialog" width="100%">
      ...
      <v-card>
        <v-card-title v-if="this.id === ''">
          <span class="text-h5">Cadastrar Novo Critério de Avaliação</span>
        </v-card-title
        >
        <v-card-title v-else>
          <span class="text-h5">Alterar Critério de Avaliação</span>
        </v-card-title>
        <v-divider></v-divider>
