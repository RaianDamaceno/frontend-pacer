<template>
  <div class="dashboard">
    ...
    <div class="dashboard-content">
      ...
      <div
        class="dashboard-content-graficos"
        v-if="showGraph && !!projectID && existNote"
      >
        <div>
          <graph-spider
            :criterios="criterios"
...
export default Vue.extend({
  ...
  methods: {
    ...
    getNotesStore: function () {
      api
        .get(`notes-store/by-sprint/${this.sprintSelected}`)
        .then(() => {
    ...
    populateNotes: function () {
      api
        .post(`notes-store/populate-notes`)
        .then((response) => {
